...
import { AllocationsService, DataShareService, UtilityService } from '../../../_services';
...
export class AllocationsListComponent implements OnInit, AfterViewInit, OnDestroy  {
  ...
  public displayedColumns: string[] = ['container_number', 'destinationName', 'yardName', 'to', 'chassis_number',
    'seal_number', 'delivery_date', 'allocationStatus', 'createdBy', 'datetime', 'edit'];
